...
Minecraft 26.1.2 + Fabric API 환경을 기준으로 설치된 모드의 목록을 정리한 리스트임.
...
|Resourceful Lib|4.0.1|Friends and Foes 의존성|https://www.curseforge.com/minecraft/mc-mods/resourceful-lib|
|Monolib|4.0.2|Dis-Enchanting Table 의존성|https://www.curseforge.com/minecraft/mc-mods/monolib|
|Cobweb|1.4.0|Harvest with Ease 의존성|https://www.curseforge.com/minecraft/mc-mods/cobweb|
|Prickle|1.2|MaxHealthFix 의존성|https://www.curseforge.com/minecraft/mc-mods/prickle|
|Puzzles Lib|26.1.11|Visual Workbench 의존성|https://www.curseforge.com/minecraft/mc-mods/puzzles-lib|
...
|Packet Fixer|3.3.5|패킷 사이즈 증가|https://www.curseforge.com/minecraft/mc-mods/packet-fixer|
|Max Health Fix|26.1.2.3|최대 체력 버그 해결|https://www.curseforge.com/minecraft/mc-mods/max-health-fix|
|Debugify|26.1.2.2|여러 알려진 버그 해결|https://www.curseforge.com/minecraft/mc-mods/debugify|
|Sparse Structures|3.1.2|구조물 등장 빈도 감소|https://www.curseforge.com/minecraft/mc-mods/sparse-structures|
|I'm Fast|1.0.3|초기 이동 속도 제약 해제|https://www.curseforge.com/minecraft/mc-mods/im-fast|
...
|Friends and Foes|4.0.26|Mob Vote에서 탈락한 몹 추가|https://www.curseforge.com/minecraft/mc-mods/friends-and-foes|
|Friends and Foes - Beekeeper Hut|3.0.3|Friends and Foes 확장, 양봉인 추가|https://www.curseforge.com/minecraft/mc-mods/friends-and-foes-beekeeper-hut-fabric|
...
|Inventory Essentials|26.1.2.3|인벤토리 추가 단축키|https://www.curseforge.com/minecraft/mc-mods/inventory-essentials|
|Openblock Elevator|1.16.3|엘레베이터 블록 추가|https://www.curseforge.com/minecraft/mc-mods/openblocks-elevator|
|Backpacked|3.0.4|가방 추가|https://www.curseforge.com/minecraft/mc-mods/backpacked|
|Harvest With Ease|9.4.0|수확 기능 확장|https://www.curseforge.com/minecraft/mc-mods/harvest-with-ease|
|Animal Feeding Through|1.2.1|동물 밥주기 기능 확장|https://www.curseforge.com/minecraft/mc-mods/animal-feeding-trough|
|Sit|1.5.1|앉기 기능 추가|https://www.curseforge.com/minecraft/mc-mods/sit-fabric|
...
|Guard Villagers|2.1.3|경비 추가|https://www.curseforge.com/minecraft/mc-mods/guard-villagers-fabric|
|Dis-enchanting Table|6.0.1|인챈트 해제 테이블 추가|https://www.curseforge.com/minecraft/mc-mods/dis-enchanting-table|
...
|Not Enought Animations|1.12.4|3인칭 애니메이션 추가|https://www.curseforge.com/minecraft/mc-mods/not-enough-animations|
|Visual Workbench|26.1.0|작업대 제작 시각화|https://www.curseforge.com/minecraft/mc-mods/visual-workbench|
...
|Name|Diversion|Explaination|URL|
|---|---|---|---|
